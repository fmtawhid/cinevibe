            ...
            <div class="col-span-2">
                ...
                <div class="w-full my-5 mb-10">
                    <p class="text-white text-justify mb-3">Cinevibe Media connects your music to a vast network of
                        ...
                        combined experience. Whether you're launching a new track or scoring for media, we help tailor
                        campaigns that match your
                        goals and position your sound where it matters. Your work isn’t just heard—it’s placed in the
                        right hands to spark
                        momentum and open doors. From viral releases to curated placements, we understand how to amplify
                        music through
                        meaningful industry relationships.</p>
                    <p class="text-white text-justify">Being a composer today takes more than musical skill—it takes
                        planning, collaboration, and a strong grasp of the
                        creative process. Whether scoring for TV, film, or video games, composers must align music with
                        visuals while keeping it
                        emotionally effective and unobtrusive. Much of the work happens behind the scenes—writing,
                        arranging, and editing in
                        digital software. Freelance composers often juggle tight deadlines, client expectations, and
                        production budgets, while
                        actively networking between projects. At Cinevibe Media, we support this journey with
                        resources, studio access, and
