            ...
            <div class="col-span-2">
                ...
                <div class="w-full my-5 mb-10">
                    <p class="text-white text-justify mb-3">Social work is a dynamic, people-focused profession that
                        ...
                        a key role in promoting development, inclusion, and empowerment by addressing real-world
                        challenges through practical,
                        compassionate solutions. In Dhaka and throughout Bangladesh, social workers contribute
                        significantly to improving lives
                        by understanding the complex layers of human behavior, cultural traditions, and socio-economic
                        realities.</p>
                    <p class="text-white text-justify">Through close collaboration with families, organizations, and
                        public institutions, social work professionals create
                        impactful changes. Whether it's supporting vulnerable groups, advocating for policy
                        improvements, or strengthening
                        community programs, their efforts help build a more equitable and connected society. Their
